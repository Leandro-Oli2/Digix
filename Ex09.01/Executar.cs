...
namespace Ex09._01
{
    public class Executar
    {
        public static void Main(string[] args){
            ...
            Account contaCorrente1 = new CurrentAccount("CD001", 1000.00, banco, cliente, 500.00);
            ...
            while (continuar)
            {
                ...
                switch (opcao)
                {
                    ...
                    case "3":
                        ...
                        if (contaOrigem != null)
                        {
                            Console.Write("Confirme o número da conta para transferência (ex: CC001 ou CP001): ");
                            ...
                            if (contaDestino != null)
                            {
                                ...
                                try
                                {
                                    contaOrigem.createTransaction("Saque", valorTransferencia, contaDestino); 
                                }
                                catch (DomainException e)
                                {
                                    Console.WriteLine(e.Message);
